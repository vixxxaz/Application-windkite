fetch('https://api.open-meteo.com/v1/forecast?latitude=40.47&longitude=22.81&hourly=temperature_2m,rain,windspeed_10m,winddirection_10m,windgusts_10m&daily=sunrise,sunset,windspeed_10m_max,windgusts_10m_max,winddirection_10m_dominant&windspeed_unit=kn&timezone=auto')
...
function weatherDisplay(data) {
    ...
    localStorage.setItem('windRiv',txtWind0);
